...
- **Belum ada endpoint analitik / Materialized View** di atas `fact_ecommerce_order_lines` — fact table-nya sendiri sudah ada sejak 2026-08-11 (batch ETL + streaming lewat `ecommerce.order.paid`/`ecommerce.order.shipped`), tapi belum ada query analitik yang memakainya.
