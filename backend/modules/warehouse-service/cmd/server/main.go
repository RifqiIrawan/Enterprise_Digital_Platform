...
import (
	...
	"github.com/enterprise-digital-platform/warehouse-service/internal/tracing"
...
func main() {
	...
	shutdownTracing := tracing.Init(ctx, "warehouse-service", cfg.OTLPEndpoint)
	...
	topHandler = otelhttp.NewHandler(topHandler, "warehouse-service")
