...
import (
	...
	"github.com/enterprise-digital-platform/hr-service/internal/tracing"
...
func main() {
	...
	shutdownTracing := tracing.Init(ctx, "hr-service", cfg.OTLPEndpoint)
	...
	topHandler = otelhttp.NewHandler(topHandler, "hr-service")
