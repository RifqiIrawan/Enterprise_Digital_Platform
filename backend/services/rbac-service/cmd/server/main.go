...
import (
	...
	"github.com/enterprise-digital-platform/rbac-service/internal/tracing"
...
func main() {
	...
	shutdownTracing := tracing.Init(ctx, "rbac-service", cfg.OTLPEndpoint)
	...
	topHandler = otelhttp.NewHandler(topHandler, "rbac-service")
